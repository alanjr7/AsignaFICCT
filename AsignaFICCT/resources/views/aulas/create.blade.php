...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Crear Nueva Aula</h2>
        </div>
        ...
        <form action="{{ route('aulas.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nro_aula" id="nro_aula" value="{{ old('nro_aula') }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="piso" id="piso" value="{{ old('piso') }}"
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           min="0" max="20"
                           required>
                    @error('piso')
